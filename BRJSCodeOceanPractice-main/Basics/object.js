...
// console.log(myObject2.firstName, myObject2.lastName, myObject2.age, myObject2.email);
...
// myObject3.favBook1 = "Physics"
// myObject3.favBook2 = "Chemistry"
// myObject3.favBook3 = "Math"
// myObject3.favNum1 = 7
// myObject3.favNum2 = 8
// myObject3.favNum3 = 9
...
let Animal = {
  ...
  let properties = {
    ...
    introduce: {
      value: function () {
        console.log(`Hey! I am ${this.name}, "Is Jack human?" ${this.isHuman}`);
      },
    },
  };
  
  human = Object.create(Animal, properties);
  human.introduce(); // ey! I am Jack, "Is Jack human?" true